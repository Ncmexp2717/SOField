...
//
	      ...
	      /* Disabled by N. Yamaguchi
	       * if (l>=l_min && l<=l_max){
	       * Data_MulP[0][l-l_min][GA_AN][i1] += Redum2A *OLP[GA_AN][LB_AN][i1][j1]; //MulP
	       * Data_MulP[1][l-l_min][GA_AN][i1] += Redum2B *OLP[GA_AN][LB_AN][i1][j1]; //MulP
	       * Data_MulP[2][l-l_min][GA_AN][i1] += Redum2C *OLP[GA_AN][LB_AN][i1][j1]; //MulP
	       * Data_MulP[3][l-l_min][GA_AN][i1] -= Imdum2D *OLP[GA_AN][LB_AN][i1][j1]; //MulP
	       * }//if
	       */
	      /* Added by N. Yamaguchi ***/
	      Data_MulP[0][l-l_min][GA_AN][i1] += Redum2A *OLP[GA_AN][LB_AN][i1][j1]; //MulP
